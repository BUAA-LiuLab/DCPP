...
from feature_graph import Mol2Graph, VirtualMol2Graph
    ...
    for i in range(len(list_smiles)):
        ...
        if len(i_smiles_combine) <= 200:
            try:
                ...
                g_merge = VirtualMol2Graph(g1, g2, 1)
                x, edge_feats, edge_index = g_merge.x, g_merge.edge_feats, g_merge.edge_index
